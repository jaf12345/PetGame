...
public class Dog extends VirtualPet implements Trainable {
    ...
    //constructor
    public Dog(String name, int hungerLevel, int energyLevel, int happinessLevel) {
        setName(name);
   ...
   //adjusts energy when eating
    ...
    public void learnTrick(String trickName) {
        this.trick = trickName;
        System.out.println("The dog has learned the trick: " + trickName);
    }

    @Override
    public void performTrick() {
        if (trick != null) {
            System.out.println("The dog performs the trick: " + trick);
        } else {
            System.out.println("The dog hasn't learned any trick yet.");
        }
    }
